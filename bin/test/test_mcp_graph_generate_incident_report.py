...
def test_main():
    print("Testing SplunkAgent_graph_generate_incident_report...")
    arguments = {
    "action": "generate_incident_report",
    "summary": "Test Summary",
    "verdict": "{\"attack\": \"brute_force\", \"probability\": 90}",
    "attack_path": "[\"user:Alice\", \"host:desktop-1\"]",
    "mitre": "{\"tactic\": \"Credential Access\"}",
    "all_hypotheses": "[{\"attack\": \"brute_force\", \"probability\": 90}]"
}
    assert call_tool("SplunkAgent_graph_generate_incident_report", arguments) == True

...
def test_main():
    print("Testing SplunkAgent_graph_get_historical_investigations...")
    arguments = {
    "action": "get_historical_investigations",
    "patient_zero_id": "user:Alice"
}
    assert call_tool("SplunkAgent_graph_get_historical_investigations", arguments) == True
